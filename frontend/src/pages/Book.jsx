  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        >
          <p className={styles.cardLabel}>Register your deposit</p>
          <BookingForm />
        </motion.div>
      </main>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerLinks}>
          <a href="https://inoffice.box.com/v/crewedcharter" target="_blank" rel="noreferrer" className={styles.footerLink}>
            Charter Terms &amp; Conditions
          </a>
          <a href="https://wa.me/38641277306" target="_blank" rel="noreferrer" className={styles.footerLink}>
